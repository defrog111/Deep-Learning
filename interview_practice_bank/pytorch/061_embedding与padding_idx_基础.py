"""
题目 061：Embedding与padding_idx_基础

要求：完成“Embedding与padding_idx”的基础题，说明训练态、梯度和张量shape。
...
embedding = nn.Embedding(num_embeddings=10, embedding_dim=6, padding_idx=0)  # 创建词嵌入并固定PAD向量。
