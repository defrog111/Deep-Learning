"""
题目 047：PermutationImportance_基础

要求：完成“PermutationImportance”的基础题，说明fit、transform和predict各自只能使用哪些数据。
...
importance = permutation_importance(model, test_x, test_y, n_repeats=4, random_state=42)  # 在测试集打乱单列测性能下降。
