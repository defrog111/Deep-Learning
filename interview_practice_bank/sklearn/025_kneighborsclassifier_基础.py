"""
题目 025：KNeighborsClassifier_基础

要求：完成“KNeighborsClassifier”的基础题，说明fit、transform和predict各自只能使用哪些数据。
...
model = make_pipeline(StandardScaler(), KNeighborsClassifier(n_neighbors=3, weights='distance'))  # 配置距离加权KNN。
